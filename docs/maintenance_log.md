...
### 2026-05-18 - Move High-Performance And Analytical Derivative Work To KrakenCore

Goal:

- Keep the public KrakenOS repository focused on the stable optical simulator while continuing high-performance tracing and analytical derivative experiments in the private KrakenCore repository.

Decision:

- Analytical sag derivative work has been moved to `C:\Users\ADMIN1\Documents\GitHub\KrakenCore`.
- Experimental ray-bundle and vectorized tracing work has been moved to `C:\Users\ADMIN1\Documents\GitHub\KrakenCore`.
- Public KrakenOS keeps the established numerical derivative tracing path for compatibility and transparency.

Public repository cleanup:

- Removed public analytical derivative examples, tests, and documentation.
- Removed public `sigma_derivative` and surface `derivative()` implementation hooks.
- Removed experimental bundle tracing code, examples, tests, and benchmarks from the public tree.
- Left PyVista-backed visualization, STL, masks, side faces, and non-sequential tracing behavior intact.

Suggested commit:

```text
Move analytical derivative work to private repo
```

```text
- Remove analytical derivative APIs, examples, tests, and docs from public KrakenOS
- Restore public tracing to the established numerical derivative path
- Keep analytical derivative and bundle tracing development in private KrakenCore
- Update examples, manual pages, representative tests, and maintenance log
```
